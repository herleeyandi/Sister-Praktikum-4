# Python stubs generated by omniidl from hello.idlj
...
#
__name__ = "HelloApp"
_0_HelloApp = omniORB.openModule("HelloApp", r"hello.idlj")
_0_HelloApp__POA = omniORB.openModule("HelloApp__POA", r"hello.idlj")
